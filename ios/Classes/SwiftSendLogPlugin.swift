...
public class SwiftSendLogPlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "hu.co.tramontana.sendlog/platform", binaryMessenger: registrar.messenger())
...
extension SwiftSendLogPlugin : MFMailComposeViewControllerDelegate {
